...
/**
 * Constants for the NSI protocol.
 * 
 * @author hacksaw
 */
public class NsiConstants {
    ...
    public static final HashMap<String, Float> NSI_CS_PROVIDERS;
    static
    {
        NSI_CS_PROVIDERS = new HashMap<>();
        NSI_CS_PROVIDERS.put(NsiConstants.NSI_CS_PROVIDER_V2, new Float(2.0));
        NSI_CS_PROVIDERS.put(NSI_CS_PROVIDER_V1_1, new Float(1.1));
        NSI_CS_PROVIDERS.put(NSI_CS_PROVIDER_V1, new Float(1.0));
    }
}
