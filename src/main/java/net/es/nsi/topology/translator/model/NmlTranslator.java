...
import net.es.nsi.topology.translator.jaxb.nml.NmlBidirectionalPortType;
import net.es.nsi.topology.translator.jaxb.nml.NmlLabelGroupType;
import net.es.nsi.topology.translator.jaxb.nml.NmlLifeTimeType;
import net.es.nsi.topology.translator.jaxb.nml.NmlPortGroupRelationType;
import net.es.nsi.topology.translator.jaxb.nml.NmlPortGroupType;
import net.es.nsi.topology.translator.jaxb.nml.NmlSwitchingServiceRelationType;
import net.es.nsi.topology.translator.jaxb.nml.NmlSwitchingServiceType;
import net.es.nsi.topology.translator.jaxb.nml.NmlTopologyRelationType;
import net.es.nsi.topology.translator.jaxb.nml.NmlTopologyType;
import net.es.nsi.topology.translator.jaxb.nml.NsiServiceDefinitionType;
